...
from .common import timed_method, PerformanceTracker
...
class VexKernelCheckerBase:
    ...
    def __init__(self, verbose: bool = False, detailed_timing: bool = False, 
                 check_patches: bool = False, analyze_all_cves: bool = False,
                 arch: Optional[str] = None, api_key: Optional[str] = None,
                 edge_driver_path: Optional[str] = None, **kwargs):
        """
