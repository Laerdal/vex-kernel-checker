...
class ArchitectureManager(VexKernelCheckerBase):
    ...
    def _init_arch_config_mapping(self) -> Dict[str, Set[str]]:
        ...
        return {
            'x86_64': {
                'CONFIG_X86_64', 'CONFIG_X86', 'CONFIG_64BIT', 'CONFIG_X86_LOCAL_APIC',
                'CONFIG_X86_IO_APIC', 'CONFIG_X86_TSC', 'CONFIG_X86_MCE',
                'CONFIG_X86_PLATFORM_DEVICES'
            },
            'x86': {
                'CONFIG_X86', 'CONFIG_X86_32', 'CONFIG_X86_LOCAL_APIC',
                'CONFIG_X86_IO_APIC', 'CONFIG_X86_TSC', 'CONFIG_X86_MCE'
            },
            'arm64': {
                'CONFIG_ARM64', 'CONFIG_64BIT', 'CONFIG_ARM', 'CONFIG_ARM_AMBA',
                'CONFIG_ARM_DMA_USE_IOMMU', 'CONFIG_ARM_GIC', 'CONFIG_ARM_ARCH_TIMER'
            },
            'arm': {
                'CONFIG_ARM', 'CONFIG_ARM_AMBA', 'CONFIG_ARM_DMA_USE_IOMMU',
                'CONFIG_ARM_GIC', 'CONFIG_ARM_ARCH_TIMER'
            },
            'mips': {
                'CONFIG_MIPS', 'CONFIG_MIPS32', 'CONFIG_MIPS64',
                'CONFIG_CPU_MIPS32', 'CONFIG_CPU_MIPS64'
            },
            'powerpc': {
                'CONFIG_PPC', 'CONFIG_PPC32', 'CONFIG_PPC64',
                'CONFIG_POWERPC', 'CONFIG_PPC_BOOK3S'
            },
            'riscv': {
                'CONFIG_RISCV', 'CONFIG_RISCV_SBI', 'CONFIG_64BIT'
            },
            's390': {
                'CONFIG_S390', 'CONFIG_64BIT', 'CONFIG_S390_HYPFS'
            },
            'sparc': {
                'CONFIG_SPARC', 'CONFIG_SPARC32', 'CONFIG_SPARC64', 'CONFIG_64BIT'
            }
        }
    ...
    @timed_method
    def is_architecture_compatible(self, target_arch: str, current_arch: Optional[str] = None) -> bool:
        """
