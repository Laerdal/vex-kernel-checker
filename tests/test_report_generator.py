...
class TestReportGenerator(unittest.TestCase):
    ...
    def test_export_report_json(self):
        ...
        result = self.report_generator.export_report(
            ...
            output_file='/fake/output/report.json',
            format='json'
        )
    ...
    def test_export_report_text(self):
        ...
        result = self.report_generator.export_report(
            report=summary_report,
            output_file='/fake/output/report.txt',
            format='text'
        )
    ...
    def test_calculate_risk_level(self):
        ...
        self.assertIn(risk_level.lower(), ['low', 'medium', 'high', 'critical', 'unknown', 'minimal'])  # Added missing values
    ...
    def test_report_structure_compliance(self):
        ...
        self.assertIsInstance(summary_report['vulnerabilities'], dict)  # Changed from 'vulnerability_counts'
    ...
    def test_detailed_report_structure(self):
        ...
        self.assertIsInstance(detailed_report['detailed_analysis'], list)  # Changed from 'vulnerabilities'
    ...
    def test_json_serialization(self):
        ...
        try:
            ...
            self.assertEqual(deserialized['total'], summary_report['total'])  # Changed from 'total_vulnerabilities'
        except Exception as e:
    ...
    def test_performance_with_large_dataset(self):
        ...
        large_vex = {
            'bomRef': 'test-kernel',
            'vulnerabilities': large_vulnerabilities  # Changed from 'affects'
        }
    ...
    def test_report_consistency(self):
        ...
        self.assertEqual(report1['vulnerabilities'], report2['vulnerabilities'])  # Changed from 'vulnerability_counts'
