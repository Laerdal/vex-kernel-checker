...
class TestCVEDataManager(unittest.TestCase):
    ...
    def test_is_kernel_related_cve_positive_cases(self):
        ...
        kernel_cve_infos = [
            ...
            CVEInfo(cve_id="CVE-2", description="Issue in kernel module affecting network stack"),
            CVEInfo(cve_id="CVE-3", description="Buffer overflow in linux filesystem"),
            CVEInfo(cve_id="CVE-4", description="Vulnerability affecting the scheduler subsystem")
        ]
        ...
        mock_response.json.return_value = {
            "vulnerabilities": [{
                "cve": {
                    ...
                    "descriptions": [{
                        "lang": "en",
                        "value": "Linux kernel vulnerability"
                    }],
