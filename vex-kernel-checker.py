...
def print_analysis_overview(vex_data: Dict, kernel_config: List[str], 
                          arch: Optional[str], disable_patch_checking: bool, 
...
def main() -> int:
    """Main entry point for the VEX Kernel Checker CLI."""
    ...
    # Required arguments
    parser.add_argument('--vex-file', required=True, 
                       help='Path to VEX JSON file')
    parser.add_argument('--kernel-config', required=True, 
                       help='Path to kernel config file (.config)')
    parser.add_argument('--kernel-source', required=True, 
                       help='Path to kernel source directory')
    
    # Optional arguments
    parser.add_argument('--output', 
                       help='Output file path (default: update VEX file in place)')
    ...
    parser.add_argument('--cve-id', 
                       help='Process only specific CVE ID')
    ...
    parser.add_argument('--edge-driver', 
    ...
    parser.add_argument('--analyze-all-cves', action='store_true', 
    ...
    try:
        ...
        # Determine patch checking settings
        ...
        print_analysis_overview(vex_data, kernel_config, arch, 
                               disable_patch_checking, args.api_key)
